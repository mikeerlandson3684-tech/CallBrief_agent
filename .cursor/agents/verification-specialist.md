...
5. Check that required docs were updated (`README.md`, `AGENTS.md`, `docs/project-map.md`, and any spec the change touched).
6. Check claimed work against authoritative probing intent (Cursor project store `docs/probing-routines.md` until it lives in this repo). Do not generate probe cycles or G-code.
